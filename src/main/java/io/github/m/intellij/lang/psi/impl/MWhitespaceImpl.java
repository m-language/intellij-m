...
public class MWhitespaceImpl extends ASTWrapperPsiElement implements MWhitespace {

  public MWhitespaceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MNosspace getNosspace() {
    return findChildByClass(MNosspace.class);
  }

  @Override
  @Nullable
  public MSspace getSspace() {
    return findChildByClass(MSspace.class);
  }
